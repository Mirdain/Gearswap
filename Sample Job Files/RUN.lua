...
function get_sets()
	...
	sets.Idle = {
		...
		body="Runeist's Coat +3", -- 3/3
		hands="Regal Gauntlets", -- 1 Refresh
		legs="Eri. Leg Guards +2", -- 12/12
		feet="Erilaz Greaves +2", -- 10/10
	...
	sets.OffenseMode.PDT = set_combine(sets.OffenseMode.TP, {
		ammo="Yamarang",
	...
	sets.SIRD = {
		...
		head="Erilaz Galea +2", -- 15 (Goes up to 20)
